...
export function Model<T>() {
  return class _Model {
    ...
    public static primaryKey: keyof T = 'id' as keyof T
     ...
     */
    static async query(queryString: string, values?: any[]): Promise<T[]> {
    ...
    getConstructor() {
      return this.constructor as typeof _Model
    }
     ...
     */
    async create() {
      const row = await this.getConstructor().create(this.attributes as T)
